<div align="center">
<img src="https://www.ucar.edu/sites/default/files/inline-images/%20logo%20banner%203.png" width=50% alt="NSF, NCAR, UCAR logos">
<img src="logos/unidata_logo_horizontal.png" width=50% alt="Unidata logo">


# UCAR Internships Professional Development Workshop Series

</div>

## Workshop: Data Management & Visualization
...
poster-ready visualization to share with your scientific audience!

## :cloud: Using [Science Gateway](http://scigw.unidata.ucar.edu/)
If you've registered for this workshop, you will do all of this work on our very own _gateway_ to the NSF Jetstream Cloud!
For this course, the sign-up sheet will serve as registration for these resources.
...
NSF Unidata is one of the University Corporation for Atmospheric Research (UCAR)'s Community Programs (UCP), and is funded primarily by the U.S. National Science Foundation (AGS-1901712).
